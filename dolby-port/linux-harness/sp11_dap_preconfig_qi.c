...
int main(int ac,char**av){
 ...
 typedef int32_t(*QiFn)(void*,const Guid*,void**);
 Guid gs[]={
  {0x67b16434,0x1ef3,0x47bc,{0x8d,0x2b,0xf4,0x85,0xee,0x14,0x8c,0x32}},
  {0x56b0c76f,0x02fd,0x4b21,{0xa5,0x2e,0x9f,0x82,0x19,0xfc,0x86,0xe4}},
  {0x92ca1caf,0x0055,0x4464,{0xa1,0x51,0x24,0xc5,0x1f,0x25,0x61,0x10}}
 };
 const char*gn[]={"preconfig","postqi","mapper"};
 for(int gi=0;gi<3;gi++){
   void *qp=NULL; void **v=*(void***)out; int32_t qhr=((QiFn)v[0])(out,&gs[gi],&qp);
   fprintf(stderr,"QI %-10s hr=%#x ptr=%p delta=%td",gn[gi],(unsigned)qhr,qp,qp?(char*)qp-(char*)out:0);
   if(qp){ void **qv=*(void***)qp; fprintf(stderr," vtable_rva=%#llx s3=%#llx s4=%#llx",(unsigned long long)((uint8_t*)qv-img.base),(unsigned long long)((uint8_t*)qv[3]-img.base),(unsigned long long)((uint8_t*)qv[4]-img.base)); }
   fputc('\n',stderr);
 }
 return 0;
