...
int main(int ac,char**av){
 ...
 Guid g_good={0x2b2e53bc,0x651b,0x4a90,{0x8f,0x64,0x38,0x53,0x1c,0x15,0x4f,0xda}};
 Guid g_alt={0xed52ac8d,0x2018,0x4d17,{0x9f,0xb2,0xe7,0xeb,0x48,0x70,0xee,0x4e}};
 Guid g_byp={0xb5bb3cae,0xfd91,0x497d,{0x8b,0x83,0x2e,0xdd,0xce,0x08,0x08,0xdb}};
 Guid *gs[]={&g_good,&g_alt,&g_byp}; const char*gn[]={"IDAP-good","IDAP-alt","StereoBypass"};
 for(int gi=0;gi<3;gi++){
   void *qp=NULL; void **v=*(void***)out; int32_t qhr=((QiFn)v[0])(out,gs[gi],&qp);
   fprintf(stderr,"QI %-12s hr=%#x ptr=%p delta=%td",gn[gi],(unsigned)qhr,qp,qp?(char*)qp-(char*)out:0);
   if(qp) fprintf(stderr," vtable_rva=%#llx",(unsigned long long)((uint8_t*)*(void**)qp-img.base));
   fputc('\n',stderr);
 }
