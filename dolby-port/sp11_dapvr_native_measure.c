...
int main(int argc,char **argv){
    install_signals();
    const char*dll=(argc>1)?argv[1]:"/home/geoca/Documents/SP11-PROJECT/00-RE-archive/recovered-adata/ubi/Documents/SP11/AUDIO/dolby/dolby-qualcomm-dissection-local/runtime-live/DolbyAudioProcessing.dll";
