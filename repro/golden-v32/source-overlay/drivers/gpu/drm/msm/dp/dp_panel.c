...
static int msm_dp_panel_read_dpcd(struct msm_dp_panel *msm_dp_panel)
{
	...
	/*
	 * The ATNA30DW01-1 OLED panel in the Surface Pro 11 can report a
	 * zero maximum link rate.  The firmware DSDT's EDPOverrideDPCDCaps
	 * data identifies the intended rate as HBR3.
	 */
