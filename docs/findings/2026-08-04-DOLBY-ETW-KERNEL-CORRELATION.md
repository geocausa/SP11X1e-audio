...
```text
$SP11_PROJECT_ROOT/Gemini/dumps/WINDOWS_KERNEL_DUMP/
...
$SP11_PROJECT_ROOT/Gemini/dumps/WINDOWS_KERNEL_DUMP/manifest.txt
$SP11_PROJECT_ROOT/Gemini/dumps/WINDOWS_KERNEL_DUMP/extra-capture.md
```
