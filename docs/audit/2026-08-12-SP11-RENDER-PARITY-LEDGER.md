...
**AMBER overall — Golden v31 is now the operator-promoted saved daily-driver/default. It inherits the v30 exact mute/DP1/DP3 gates, closes the pathological 40-Hz Volume-Up transient to the native-Windows/room-floor class on two independent SP7 captures, and retains deterministic seek closure. Golden v28 remains rollback/comparison and CPS-v3 remains rescue. The principal remaining built-in-speaker physical-parity work is repeated **SP7 WASAPI-RAW** Windows-vs-Linux L/R transfer plus low-bass/psychoacoustic-bass A/B; older shared-mode absolute L/R dB figures are provisional and must not drive tuning. P09 and W02 remain explicitly non-blocking; clean public source packaging remains separate from sound-quality closure.**
