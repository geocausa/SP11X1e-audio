...
There is no known functional blocker in the tested non-suspend built-in audio
chain. Keep v18 as an explicit rollback entry even after v19c promotion. Future
